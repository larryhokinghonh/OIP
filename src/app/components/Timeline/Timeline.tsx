    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={timelineRef} className="relative">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-blue-400 via-purple-500 to-pink-500 hidden md:block" style={{height: 'calc(100% - 120px)'}}></div>
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full md:w-5/12 ${isLeft ? 'md:pr-8' : 'md:pl-8'}`}>
                    <Card className={`
                      p-6 bg-white/10 backdrop-blur-sm border border-white/20 
                      transform transition-all duration-700 ease-out
                      ${isVisible 
                        ? 'translate-y-0 opacity-100 scale-100' 
                        : `${isLeft ? '-translate-x-8' : 'translate-x-8'} translate-y-8 opacity-0 scale-95`
                      }
                    ...
                    `}>
                      ...
                      <div className="text-blue-100 mb-4 leading-relaxed">
